...
class CRM_M365GroupSync_Service_Mapping {
  public static function all(): array {
    ...
    LEFT JOIN civicrm_m365_sync_run r ON r.id = (
              SELECT r2.id FROM civicrm_m365_sync_run r2
               WHERE r2.civicrm_group_id = m.civicrm_group_id
  ...
  public static function getM365Id(int $groupId): string {
    return (string) CRM_Core_DAO::singleValueQuery('SELECT m365_group_id FROM civicrm_m365_group_mapping WHERE civicrm_group_id = %1', [1 => [$groupId, 'Positive']]);
  }
  ...
  public static function unmappedGroups(): array {
    ...
    LEFT JOIN civicrm_m365_group_mapping m ON m.civicrm_group_id = g.id
  ...
  public static function isMappedElsewhere(string $m365Id, int $groupId): bool {
    return (bool) CRM_Core_DAO::singleValueQuery(
      'SELECT civicrm_group_id FROM civicrm_m365_group_mapping WHERE m365_group_id = %1 AND civicrm_group_id <> %2',
      [1 => [$m365Id, 'String'], 2 => [$groupId, 'Positive']]
    );
  }
  ...
  public static function save(int $groupId, string $m365Id): void {
    ...
    try {
      ...
      try {
        if ($m365Id === '') {
          CRM_Core_DAO::executeQuery('DELETE FROM civicrm_m365_group_mapping WHERE civicrm_group_id = %1', [1 => [$groupId, 'Positive']]);
          return;
        }
        CRM_Core_DAO::executeQuery(
          'INSERT INTO civicrm_m365_group_mapping (civicrm_group_id,m365_group_id,m365_display_name,m365_mail,created_date,modified_date)
          ...
          [1 => [$groupId, 'Positive'], 2 => [$m365Id, 'String'], 3 => [$group['displayName'], 'String'], 4 => [$group['mail'], 'String']]
        );
      }
      finally {
        $lock->release();
